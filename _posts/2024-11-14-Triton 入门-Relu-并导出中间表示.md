...
def get_asm():
    ...
    y = torch.empty_like(x)
    gridDim = lambda meta: (triton.cdiv(size, meta["BLOCK_SIZE"]),)
    relu_compiled = relu_kernel[gridDim](x, y, size, BLOCK_SIZE=256)
    for k, v in relu_compiled.asm.items():
...
```plain_text
module {
  tt.func public @relu_kernel_0d1d2d(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg2: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
...
还是 mlir，tt gpu ir。 表示和硬件相关的计算表示。
...
define void @relu_kernel_0d1d2d(ptr addrspace(1) %0, ptr addrspace(1) %1, i32 %2) local_unnamed_addr !dbg !5 {
  ...
  %18 = fcmp ogt float %16, 0.000000e+00, !dbg !15
  %19 = fcmp ogt float %17, 0.000000e+00, !dbg !15
  %20 = select i1 %18, float %16, float 0.000000e+00, !dbg !19
  %21 = select i1 %19, float %17, float 0.000000e+00, !dbg !19
  %22 = getelementptr float, ptr addrspace(1) %1, i64 %11, !dbg !20
  %23 = bitcast float %20 to i32, !dbg !21
  %24 = bitcast float %21 to i32, !dbg !21
  tail call void asm sideeffect "@$3 st.global.v2.b32 [ $2 + 0 ], { $0, $1 };", "r,r,l,b"(i32 %23, i32 %24, ptr addrspace(1) %22, i1 %10) #1, !dbg !21
  ret void, !dbg !22
}
...
!3 = !{ptr @relu_kernel_0d1d2d, !"kernel", i32 1}
!4 = !{ptr @relu_kernel_0d1d2d, !"maxntidx", i32 128}
!5 = distinct !DISubprogram(name: "relu_kernel_0d1d2d", linkageName: "relu_kernel_0d1d2d", scope: !2, file: !2, line: 10, type: !6, scopeLine: 10, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !1)
!6 = !DISubroutineType(cc: DW_CC_normal, types: !7)
!7 = !{}
!8 = !DILocation(line: 13, column: 55, scope: !5)
!9 = !DILocation(line: 13, column: 24, scope: !5)
!10 = !DILocation(line: 13, column: 29, scope: !5)
!11 = !DILocation(line: 13, column: 42, scope: !5)
!12 = !DILocation(line: 15, column: 17, scope: !5)
!13 = !DILocation(line: 17, column: 24, scope: !5)
!14 = !DILocation(line: 17, column: 16, scope: !5)
...
!18 = !DILocation(line: 18, column: 22, scope: !16)
!19 = !DILocation(line: 1398, column: 27, scope: !16, inlinedAt: !18)
!20 = !DILocation(line: 19, column: 21, scope: !5)
!21 = !DILocation(line: 19, column: 26, scope: !5)
...
.address_size 64
	...
	// .globl	relu_kernel_0d1d2d

.visible .entry relu_kernel_0d1d2d(
	.param .u64 relu_kernel_0d1d2d_param_0,
	.param .u64 relu_kernel_0d1d2d_param_1,
	.param .u32 relu_kernel_0d1d2d_param_2
)
.maxntid 128, 1, 1
{
	.reg .pred 	%p<3>;
...
$L__func_begin0:
	...
	ld.param.u64 	%rd3, [relu_kernel_0d1d2d_param_0];
	ld.param.u64 	%rd4, [relu_kernel_0d1d2d_param_1];
$L__tmp0:
	.loc	1 13 55
	mov.u32 	%r5, %tid.x;
	shl.b32 	%r6, %r5, 1;
	ld.param.u32 	%r7, [relu_kernel_0d1d2d_param_2];
	and.b32  	%r8, %r6, 254;
	.loc	1 13 24
	mov.u32 	%r9, %ctaid.x;
	.loc	1 13 29
