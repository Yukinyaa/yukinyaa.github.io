...
和 Tilelang 群友友好交流了[之前关于 L2 优化矩阵乘算法的疑问](https://wu-kan.cn/2024/11/22/Triton-%E5%85%A5%E9%97%A8-L2-%E5%8F%8B%E5%A5%BD%E7%9A%84%E7%9F%A9%E9%98%B5%E4%B9%98/)，本文基于 Tilelang 实现 matmul 算子，验证 L2 分块算法。**或许是哪里写的有问题，现在的代码性能完全不及预期，且存在显存泄露情况。待和群友进一步请教。**

![matmul-tflops](https://Mizuno-Ai.wu-kan.cn/assets/image/2025/07/05/wechat-group.webp)

参考了官方 [example_gemm_schedule.py](https://github.com/tile-ai/tilelang/blob/v0.1.5/examples/gemm/example_gemm_schedule.py)，我在官方示例的基础上增加了 `panel_size == 0` 时不使用 `T.use_swizzle` 策略。同时导出运行时的层层下降的中间表示，用于观察 tilelang 生成算子的具体逻辑。
